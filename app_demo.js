...
function getInstrumentHSL(instrument, type, isCall) {
  ...
  if (instrument) {
    ...
    if (instrument.includes("dundunba")) {
      if (isBell) {
        if (instrument.includes("3")) return "235, 98%, 72%"; // Bell 2 (Blue)
        if (instrument.includes("4")) return "225, 98%, 74%"; // Bell 3 (Blue)
        return "245, 98%, 70%"; // Bell 1 (Blue)
      } else {
        if (instrument.includes("3")) return "250, 98%, 75%"; // Dundunba 3 (Blue)
        if (instrument.includes("4")) return "260, 98%, 76%"; // Dundunba 4 (Blue)
        return "240, 98%, 68%"; // Dundunba 1 (Blue)
      }
    }
  }
